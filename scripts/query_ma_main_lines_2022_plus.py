...
from output import fail, log, warn
...
def fetch_features_by_where(session, layer_url, where, out_fields, page_size, with_geometry, expected_count):
    ...
    page = 1
    while True:
        data = post_query_json(session, query_url, {
            "where": where,
